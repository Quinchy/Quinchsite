...
function Quinch() {
  ...
  return (
    <div className='flex flex-col items-center justify-center mt-[8rem] gap-32 overflow-hidden max-w-6xl mx-auto px-4 sm:px-8 md:px-16 lg:px-24 xl:px-32 2xl:px-48'>
      {/* 1. Heading */}
      <div className='flex flex-col items-center gap-5 md:items-start'>
        <div className='flex flex-col-reverse items-center gap-12 md:gap-5 md:flex-row lg:gap-24 xl:gap-40'>
      ...
      <footer className='w-full'> 
        <div className='flex flex-row items-center justify-center gap-[2rem] md:gap-[12rem] mb-10 pt-10 text-[--color-main-light] border-t border-[--color-main-light-opacity2]'>
          {/* Links */}
          ...
          <div className='flex flex-col items-end'>
            <p className='text-[0.55rem] md:text-[0.85rem]'>© 2024 Cyril James De Guzman. All Rights Reserved.</p>
            <p className='text-[0.55rem] md:text-[0.85rem]'>Made using Next JS, with Aceternity UI.</p>
          </div>
        </div>
      </footer>
    </div>
