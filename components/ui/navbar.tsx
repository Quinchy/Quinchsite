...
const Navbar = () => {
  ...
  return (
    <motion.div
    initial={{ backgroundColor: 'var(--color-background)', width: '30rem', boxShadow: 'none' }}
    animate={{
        backgroundColor: scrolled ? 'var(--color-background-opacity2)' : 'var(--color-background)',
        width: scrolled ? '25rem' : '30rem',
...
>
    <div className="container mx-auto">
        <div className="flex justify-center items-center gap-10 text-lg tracking-tighter font-semibold text-[--color-main-light]">
